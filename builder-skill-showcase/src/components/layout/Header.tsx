The user wants to add a Leaderboard link to the Header component's navigation.
```
...
};The user wants to add a Leaderboard link to the Header component and include it in the mobile menu.